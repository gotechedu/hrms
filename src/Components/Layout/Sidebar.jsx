  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { name: 'Squad Chat & DMs', path: '/chat', icon: MessageSquare, badge: '3' },
      ],
    },
    {
      group: 'People & Attendance',
      items: [
        { name: 'Employee Directory', path: '/employees', icon: Users, badge: '6' },
    ...
    },
    {
      ...
      items: [
        { name: 'Job Applications', path: '/applications', icon: UserCheck, badge: '4' },
        { name: 'Grievances & Policy', path: '/accusations', icon: ShieldAlert },
            ...
            <div className="flex items-center gap-3">
              ...
              {!sidebarCollapsed && (
                <div className="flex flex-1 flex-col min-w-0">
                  ...
                  <span className="text-[10px] font-medium text-slate-500 truncate">{user.role}</span>
                </div>
              )}
              {!sidebarCollapsed && (
                <button
                  ...
                  title="Logout"
                  className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:bg-slate-200/80 hover:text-rose-600 transition"
                >
                  <LogOut size={16} />
                </button>
              )}
