...
import { Mail, ArrowLeft, CheckCircle2, KeyRound, Lock, ShieldCheck, AlertCircle, ArrowRight } from 'lucide-react';
import {
...
export default function ForgotPassword() {
  ...
  const { loading, error, forgotPasswordSuccess, resetPasswordSuccess, demoOtp } = useSelector(
    (state) => state.auth
  );
        ...
        <div className="rounded-3xl border border-slate-200/90 bg-white p-7 sm:p-9 shadow-xl shadow-slate-200/60">
            ...
            <form onSubmit={handleRequestOtp} className="space-y-4">
              <div>
                ...
                <p className="text-[11px] text-slate-500 mt-1.5 leading-relaxed">
                  We will issue a 6-digit authentication token valid for 15 minutes.
                </p>
              </div>
          ...
          {step === 2 && (
            <form onSubmit={handleResetPassword} className="space-y-4 animate-fadeIn">
              <div className="rounded-xl bg-blue-50 p-3 text-xs text-blue-900 border border-blue-200 flex items-start gap-2">
                ...
                <div>
                  <span>Token dispatched for <strong>{email}</strong>.</span>
                  {demoOtp && (
          ...
          {step === 3 && (
            <div className="text-center space-y-4 animate-fadeIn">
              ...
              <h3 className="text-lg font-heading font-bold text-slate-900">Password Reset Successful</h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                Your login credentials have been securely updated in the directory database.
              </p>
              <button
                type="button"
