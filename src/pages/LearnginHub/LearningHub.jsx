...
export default function LearningHub() {
  ...
  const [selectedCourseForCurriculum, setSelectedCourseForCurriculum] =
    useState(null);
  ...
  const openEditModal = (c) => {
    ...
    setForm({
      ...
      modules: Array.isArray(c.modules)
        ? c.modules.join("\n")
        : c.modules || "",
      whatYouWillLearn: Array.isArray(c.whatYouWillLearn)
        ...
        <>
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
                Create and maintain enterprise tech stack programs published
                live to the official student portal
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="rounded-2xl border border-slate-200/80 bg-white p-3.5 shadow-2xs">
              ...
              <p className="text-xl font-heading font-black text-slate-900 mt-1">
                {courses.length}
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200/80 bg-white p-3.5 shadow-2xs">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-3.5 shadow-2xs">
              ...
              <p className="text-xs font-bold text-blue-700 uppercase mt-2 font-mono">
                Live MongoDB
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200/80 bg-white p-3.5 shadow-2xs">
              <span className="text-[11px] font-mono font-bold uppercase text-purple-600">
                Official Portal
              </span>
              <p className="text-xs font-bold text-purple-700 uppercase mt-2 font-mono">
                /learninghub
              </p>
            </div>
          </div>
          ...
          {loading ? (
            <div className="py-20 text-center">
              ...
              <p className="mt-3 text-xs text-slate-500 font-mono">
                Loading curriculum catalog from database...
              </p>
            </div>
          ) : courses.length === 0 ? (
            <div className="rounded-3xl border border-slate-200 bg-white p-12 text-center shadow-2xs">
              ...
              <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
                Click "Publish Tech Stack" above to create a new bootcamp
                curriculum.
              </p>
            </div>
          ) : viewMode === "table" ? (
                ...
                >
                  <div>
                    ...
                    <h3 className="mt-4 font-heading text-lg font-bold text-slate-900 group-hover:text-blue-600 transition">
                      <Link to={`/learninghub/${course._id}`}>
                        {course.title}
                      </Link>
                    </h3>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div>
                <h3 className="font-heading text-lg font-bold text-slate-900">
                  {editingCourse
                    ? "Edit Learning Curriculum"
                    : "Publish New Learning Tech Stack"}
                </h3>
                <p className="text-xs text-slate-500">
                  Configure multi-tab program parameters published to official
                  student portal.
                </p>
              </div>
              <button
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, lecturesCount: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, nextBatchDate: e.target.value })
                        }
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, emiStartsAt: e.target.value })
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({
                            ...form,
                            averageSalaryHike: e.target.value,
                          })
                        }
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, careerOutcome: e.target.value })
                        }
                  ...
                  <div>
                    ...
                    <div className="p-3 bg-blue-50/70 border border-blue-100 rounded-xl text-xs space-y-1 text-slate-700">
                      <p className="font-bold text-blue-800">
                        Enabled Coupons on Portal:
                      </p>
                      <p>
                        • <strong>GOTECH50</strong>: 50% Flat Scholarship
                        Discount
                      </p>
                      <p>
                        • <strong>EARLYBIRD</strong>: Flat ₹5,000 Instant Fee
                        Waiver
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-3.5 animate-fadeIn">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, instructorBio: e.target.value })
                      }
      ...
      {isCandidateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto">
          <div className="relative w-full max-w-2xl rounded-2xl bg-white p-6 sm:p-8 shadow-2xl my-8">
            ...
            <form
              onSubmit={handleEnrollCandidate}
          ...
          <div className="relative w-full max-w-4xl rounded-2xl bg-white p-6 sm:p-8 shadow-2xl my-8">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Create targeted discounts (All Courses, Specific Course, or
                  Specific Student) and configure portal popup permissions.
                </p>
              </div>
              <button
                type="button"
            ...
            <form
              ...
              className="mt-5 rounded-2xl border border-amber-200/80 bg-amber-50/40 p-5 space-y-4 text-xs"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setOfferForm({ ...offerForm, couponType: e.target.value })
                    }
                  ...
                  >
                    <option value="ALL_COURSES">
                      🌐 Whole Application (All Courses)
                    </option>
                    <option value="SPECIFIC_COURSE">
                      📚 Course-Wise (Specific Course)
                    </option>
                    <option value="SPECIFIC_STUDENT">
                      👤 Student-Wise (Specific Email)
                    </option>
                  </select>
                </div>
                  ...
                  <div className="animate-fadeIn">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setOfferForm({
                          ...offerForm,
                          targetStudentEmail: e.target.value,
                        })
                      }
                      className="h-9 w-full rounded-xl border border-slate-200 bg-white px-3 focus:border-amber-600 focus:outline-none"
                    />
                ...
                <div className="flex items-center gap-2 pt-5">
                  <input
                    ...
                    onChange={(e) =>
                      setOfferForm({
                        ...offerForm,
                        isVisibleOnPortal: e.target.checked,
                      })
                    }
                    className="h-4 w-4 rounded border-slate-300 text-amber-600 focus:ring-amber-500 cursor-pointer"
                  />
                  <label
                    htmlFor="isVisibleOnPortal"
            ...
            <div className="mt-6">
              <h4 className="font-bold text-slate-900 text-sm mb-3">
                Active Offers & Portal Visibility
              </h4>
                          ...
                          <td className="p-3">
                            ...
                            {off.couponType === "SPECIFIC_COURSE" && (
                              <span className="rounded-full bg-purple-50 border border-purple-200 text-purple-800 px-2.5 py-0.5 text-[10px] font-bold">
                                📚 Course:{" "}
                                {off.targetCourseTitle || "Specific Course"}
                              </span>
                            )}
